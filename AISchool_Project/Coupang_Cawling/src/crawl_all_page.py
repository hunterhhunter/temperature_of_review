...
base_url = "https://www.coupang.com/np/search?q=%ED%94%84%EB%A6%B0%ED%84%B0%2F%EB%B3%B5%ED%95%A9%EA%B8%B0&channel=user&component=&eventCategory=SRP&trcid=&traid=&sorter=scoreDesc&minPrice=&maxPrice=&priceRange=&filterType=&listSize=36&filter=&isPriceRange=false&brand=&offerCondition=&rating=0&page={}&rocketAll=false&searchIndexingToken=1=9&backgroundColor="
...
class OpenPyXLNo:
    ...
    def save_file()-> None:
        ...
        if os.path.exists(filePath):
            ...
            wb = Workbook()
            ws = wb.active
            ws.append(['상품명','구매자 평점','리뷰 제목','리뷰 내용'])
